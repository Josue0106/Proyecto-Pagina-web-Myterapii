  ...
  const faqs = [
    {
      ...
      answer: "La sesión suele durar entre 45 y 60 minutos, según el caso.",
    },
    {
      question: "¿Necesito derivación médica?",
      answer: "No siempre. Si la necesitas para tu caso, te orientaré en la primera valoración.",
    },
    {
      question: "¿Puedo reservar en línea?",
      answer: "Sí, puedes reservar desde la página de Reservar cita en pocos pasos.",
    },
  ];
  ...
  return (
    <main className="mx-auto min-safe-screen w-full max-w-7xl px-6 py-24 sm:px-10 lg:px-12 pb-safe">
      ...
      <p className="mt-6 max-w-3xl text-base leading-8 text-slate-600 sm:text-lg">
        Aquí encontrarás respuestas claras a las dudas más habituales sobre las sesiones y el proceso de reserva.
      </p>
