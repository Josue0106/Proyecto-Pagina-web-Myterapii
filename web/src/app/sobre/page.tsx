...
export default function AboutPage() {
  ...
  return (
    <main className="mx-auto min-safe-screen w-full max-w-7xl px-6 py-24 sm:px-10 lg:px-12 pb-safe">
      <PageTopbar />
      <p className="text-xs tracking-[0.3em] uppercase text-teal-700">Sobre mí</p>
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <article className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <p className="mt-4 text-sm leading-8 text-slate-600">
            Acompaño a personas con dolor musculoesquelético, lesiones deportivas y molestias recurrentes para que recuperen movimiento y seguridad en su día a día.
          </p>
          <p className="mt-4 text-sm leading-8 text-slate-600">
            Mi forma de trabajar combina valoración clínica, terapia manual y ejercicio terapéutico para que cada sesión tenga un objetivo claro y una progresión real.
          </p>
        </article>
